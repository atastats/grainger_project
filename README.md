...
5. product_query: If the product is inaccurately matched to the query (is_accurate = false), create a new query using ONLY the product details that would NOT conflict with the product; otherwise null
...
{{"query_specs": [...], "product_specs": [...], "conflict": "brief explanation or null", "is_accurate": true or false, "product_query": "new query based on product_specs or null"}}
